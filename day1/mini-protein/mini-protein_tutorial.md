...
Use PuTTY to connect to bigzam as you did in the previous [tutorial](link here). Open PuTTY from the Window Start menu and enter `bigzam.local` for the Host Name. Log in using the terminal using your username and password:
...
{% highlight git %}
gxm editconf -f conf.gro -o conf_box.gro -c -d 1.0 -bt cubic
{% endhighlight %}
